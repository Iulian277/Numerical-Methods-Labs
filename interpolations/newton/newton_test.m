% [ABOUT]
%       This is a tester function for Newton Interpolation
% [USES]
%       interpolations/newton/newton.m 
...
function [] = newton_test()
    ...
    for i = 1 : length(x)
        if ((polyval(P, x(i)) - y(i)) > 1e-2)
          disp('Newton polynomial does not respect the conditions!');
